    ...
    switch(column)
    {
        case 1:
            if(sellState == 1)
            {
                ...
                {
                    cerr << endl << "\033[31mError:\033[0m The input is invalid." << endl;
...
void Hero::DisplayProdsForSale(const bool& showInfo, const int& sellState)
{
    ...
    {
        if(sellState == 2)
            cout << "\033[34m|\033[0m\033[64C\033[4mAvailable Actions\033[0m: 1. Proceed, 2. Disable Info, 3. Cancel\033[64C\033[34m|\033[0m" << endl;
        else
            cout << "\033[34m|\033[0m                 \033[4mAvailable Actions\033[0m: 1. Proceed, 2. Disable Info, 3. Cancel                  \033[34m|\033[0m" << endl;
    }
    else
    {
        if(sellState == 2)
            cout << "\033[34m|\033[0m\033[68C\033[4mAvailable Actions\033[0m: 1. Proceed, 2. Info, 3. Cancel\033[68C\033[34m|\033[0m" << endl;
        else
            cout << "\033[34m|\033[0m                      \033[4mAvailable Actions\033[0m: 1.Proceed, 2. Info, 3. Cancel                      \033[34m|\033[0m" << endl;
    }
    ...
    if(sellState == 2)
        ...
        cout << "\033[34m|\033[0m                                           Items                                            \033[34m|\033[0m" << endl;
    else
        cout << "\033[34m|\033[0m                                           Spells                                           \033[34m|\033[0m" << endl;
    ...
    if(showInfo)
    {
        ...
        else if(sellState == 1)
        {
            ...
            cout << "\033[34m|\033[0m    --> There are items that a hero can use for attacking enemies, avoiding their attacks   \033[34m|\033[0m" << endl;
            cout << "\033[34m|\033[0m        and items that increase some of his features                                        \033[34m|\033[0m" << endl;
            cout << "\033[34m|\033[0m    --> Some of them can be used one time only                                              \033[34m|\033[0m" << endl;
        }
        else
        {
            cout << "\033[34m|--------------------------------------------------------------------------------------------\033[1;33m+\033[0;34m" << endl;
            cout << "\033[34m|\033[0m    --> Spells are representing a magic attack that a hero can perform                      \033[34m|\033[0m" << endl;
            cout << "\033[34m|\033[0m    --> They cause an amount of damage according to the hero's dexterity                    \033[34m|\033[0m" << endl;
            cout << "\033[34m|\033[0m    --> They require a specific Magic Power that the hero must have in order to use them    \033[34m|\033[0m" << endl;
            cout << "\033[34m|\033[0m    --> After the use of a spell the Hero's Magic Power will be reduced                     \033[34m|\033[0m" << endl;
        }
    }
    ...
    if(sellState == 2)
        ...
        cout << "\033[1;33m+\033[0;34m===\033[1;33m+\033[0;34m==========================\033[1;33m+\033[0;34m===\033[1;33m+\033[0;34m==========================\033[1;33m+\033[0;34m===\033[1;33m+\033[0;34m==========================\033[1;33m+\033[0m" << endl;
    ...
    if(sellState == 2)
        ...
        cout << "\033[34m|\033[0m # \033[34m|\033[0m         \033[38;5;166mWeapons\033[0m          \033[34m|\033[0m # \033[34m|\033[0m          \033[38;5;28mArmors\033[0m          \033[34m|\033[0m # \033[34m|\033[0m         \033[38;5;90mPotions\033[0m          \033[34m|\033[0m" << endl;
    else
        cout << "\033[34m|\033[0m # \033[34m|\033[0m        \033[38;5;32mIce Spells\033[0m        \033[34m|\033[0m # \033[34m|\033[0m       \033[1;31mFire Spells\033[0m        \033[34m|\033[0m # \033[34m|\033[0m     \033[38;5;15mLighting Spells\033[0m      \033[34m|\033[0m" << endl;
    ...
    if(showInfo)
    {
        ...
        {
            cout << "\033[1;33m+\033[0;34m---\033[1;33m+\033[0;34m--------------------------\033[1;33m+\033[0;34m---\033[1;33m+\033[0;34m--------------------------\033[1;33m+\033[0;34m---\033[1;33m+\033[0;34m--------------------------|\033[0m" << endl;
            cout << "\033[34m|\033[1;33m(i)\033[0;34m|\033[0m   Weapons cause damage   \033[34m|\033[1;33m(i)\033[0;34m|\033[0m    Armors reduce the     \033[34m|\033[1;33m(i)\033[0;34m|\033[0m     Potions increase     \033[34m|\033[0m" << endl;
            cout << "\033[34m|\033[1;33m(i)\033[0;34m|\033[0m    to the enemies and    \033[34m|\033[1;33m(i)\033[0;34m|\033[0m     received damage      \033[34m|\033[1;33m(i)\033[0;34m|\033[0m    a hero's specific     \033[34m|\033[0m" << endl;
            cout << "\033[34m|\033[1;33m(i)\033[0;34m|\033[0m     they require one     \033[34m|   |                          |\033[1;33m(i)\033[0;34m|\033[0m     feature and can      \033[34m|\033[0m" << endl;
            cout << "\033[34m|\033[1;33m(i)\033[0;34m|\033[0m       or two hands       \033[34m|   |                          |\033[1;33m(i)\033[0;34m|\033[0m    be used only once     \033[34m|\033[0m" << endl;
        }
        else
        {
            cout << "\033[1;33m+\033[0;34m---\033[1;33m+\033[0;34m--------------------------\033[1;33m+\033[0;34m---\033[1;33m+\033[0;34m--------------------------\033[1;33m+\033[0;34m---\033[1;33m+\033[0;34m--------------------------|\033[0m" << endl;
            cout << "\033[34m|\033[1;33m(i)\033[0;34m|\033[0m    Ice Spells reduce     \033[34m|\033[1;33m(i)\033[0;34m|\033[0m    Fire Spells reduce    \033[34m|\033[1;33m(i)\033[0;34m|\033[0m  Lighting Spells reduce  \033[34m|\033[0m" << endl;
            cout << "\033[34m|\033[1;33m(i)\033[0;34m|\033[0m   enemy's damage range   \033[34m|\033[1;33m(i)\033[0;34m|\033[0m     enemy's defence      \033[34m|\033[1;33m(i)\033[0;34m|\033[0m    enemy's chance to     \033[34m|\033[0m" << endl;
            cout << "\033[34m|   |                          |   |                          |\033[1;33m(i)\033[0;34m|\033[0m     avoid an attack      \033[34m|\033[0m" << endl;
            cout << "\033[34m|   |                          |   |                          |   |                          |\033[0m" << endl;
        }
    }
    ...
    for(unsigned int i = 0; i < mostItems; i++)
    {
        if(i < iceSpellsArray.size())
        {
            ...
            cout.width(23);
            cout << left << iceSpellsArray[i]->GetName() << "\033[0m";
        }
        else if(sellState != 1)
        ...
        if(i < fireSpellsArray.size())
        {
            ...
            cout.width(23);
            cout << left << fireSpellsArray[i]->GetName() << "\033[0m";
        }
        else if(sellState != 1)
            cout << "\033[34m|   |\033[0m\033[26C";
        ...
        if(i < lightingSpellsArray.size())
        {
            ...
            cout.width(23);
            cout << left << lightingSpellsArray[i]->GetName() << "\033[0m";
        }
        else if(sellState != 1)
            cout << "\033[34m|   |\033[0m\033[26C";
        ...
        if(i < weaponsArray.size())
        {
            ...
            cout.width(23);
            cout << left << weaponsArray[i]->GetName() << "\033[0m";
        }
        else if(sellState != 0)
            cout << "\033[34m|   |\033[0m\033[26C";
        ...
        if(i < armorsArray.size())
        {
            ...
            cout.width(23);
            cout << left << armorsArray[i]->GetName() << "\033[0m";
        }
        else if(sellState != 0)
            cout << "\033[34m|   |\033[0m\033[26C";
        ...
        if(i < potionsArray.size())
        {
            ...
            cout.width(23);
            cout << left << potionsArray[i]->GetName() << "\033[0;34m|\033[0m";
        }
        else if(sellState != 0)
            cout << "\033[34m|   |\033[26C|\033[0m";
    ...
    /* ------------------------------- Start of 1st Line ------------------------------- */
            ...
            if(i < iceSpellsArray.size())
            {
                cout << "\033[34m|\033[1;33m(i)\033[0;34m|\033[0m ~> Selling Price: ";
                cout.width(7);
            ...
            if(i < lightingSpellsArray.size())
            {
                cout << "\033[34m|\033[1;33m(i)\033[0;34m|\033[0m ~> Selling Price: ";
                cout.width(7);
                cout << left << lightingSpellsArray[i]->GetPrice() / 2 << "\033[34m|\033[0m";
            }
            else if(sellState != 1)
                cout << "\033[34m|   |\033[26C|\033[0m";
            ...
            if(i < weaponsArray.size())
            {
                cout << "\033[1;33m(i)\033[0;34m|\033[0m ~> Selling Price: ";
                cout.width(7);
            ...
            if(i < potionsArray.size())
            {
                cout << "\033[34m|\033[1;33m(i)\033[0;34m|\033[0m ~> Selling Price: ";
                cout.width(7);
                cout << left << potionsArray[i]->GetPrice() / 2 << "\033[34m|\033[0m";
            }
            else if(sellState != 0)
                cout << "\033[34m|   |\033[26C|\033[0m";
    ...
    /* ------------------------------- Start of 2nd Line ------------------------------- */
            ...
            if(i < weaponsArray.size())
            {
                cout << "\033[1;33m(i)\033[0;34m|\033[0m ~> Damage: ";
                cout.width(14);
    ...
    /* ------------------------------- Start of 3rd Line ------------------------------- */
            ...
            if(i < lightingSpellsArray.size())
            {
                ...
                cout.width(4);
                cout << left << (to_string(lightingSpellsArray[i]->GetAvoidanceReduction()) + "%") << "\033[34m|\033[0m";
            }
            else if(sellState != 1)
                cout << "\033[34m|   |\033[26C|\033[0m";
            ...
            if(i < weaponsArray.size())
            {
                cout << "\033[1;33m(i)\033[0;34m|\033[0m ~> Required Hands: ";
                cout.width(6);
    ...
    /* ------------------------------- Start of 4th Line ------------------------------- */
            ...
            if(i < lightingSpellsArray.size())
                cout << "\033[34m|\033[1;33m(i)\033[0;34m|\033[0m    Reduction       ·     \033[34m|\033[0m";
            else if(sellState != 1)
                cout << "\033[34m|   |\033[26C|\033[0m";
    ...
    /* ------------------------------- Start of 5th Line ------------------------------- */
            ...
            if(i < lightingSpellsArray.size())
            {
                cout << "\033[34m|\033[1;33m(i)\033[0;34m|\033[0m ~> Applies to: ";
                cout.width(10);
                cout << left << (to_string(lightingSpellsArray[i]->GetRounds()) + " rounds") << "\033[34m|\033[0m";
            }
            else if(sellState != 1)
                cout << "\033[34m|   |\033[26C|\033[0m";
    ...
    /* -------------------------------- End of 5th Line -------------------------------- */
            ...
            if(sellState == 2)
                ...
                cout << "\033[34m|   |\033[26C|   |\033[26C|   |\033[26C|\033[0m" << endl;
        }
    ...
    cout << endl;
    cout << "\033[38;5;220m  Hero: \033[0m" << name << endl;
    cout << "\033[38;5;220m Money: \033[0m" << money << endl;
    cout << "\033[38;5;220m Items: \033[0m(" << maxItemSlots - availableItemSlots << "/" << maxItemSlots << ")" << endl;
    cout << "\033[38;5;220mSpells: \033[0m(" << maxSpellsSlots - availableSpellSlots << "/" << maxSpellsSlots << ")" << endl;
}
...
bool Hero::DisplaySpells(Spell*& chosenSpell , unsigned int& slotNum , unsigned int& type)
{
    ...
    do{
        cout << "\033[1;33m+\033[0;34m==============================\033[1;33m+\033[0;34m==============================\033[1;33m+\033[0;34m==============================\033[1;33m+\033[0m" << endl;
        cout << "\033[34m|\033[0m          Ice Spells          \033[34m|\033[0m         Fire Spells          \033[34m|\033[0m       Lighting Spells        \033[34m|\033[0m" << endl;
        cout << "\033[1;33m+\033[0;34m------------------------------\033[1;33m+\033[0;34m------------------------------\033[1;33m+\033[0;34m------------------------------\033[1;33m+\033[0m";
        ...
        for(unsigned int i = 0; i < iceSpellsArray.size() || i < fireSpellsArray.size() || i < lightingSpellsArray.size(); i++)
        {
            ...
            {
                if(column == 0 && arrow == i)
                    cout << "\033[34m| \033[1;33m~> ";
                else
                    cout << "\033[34m|\033[0m    ";

                cout.width(26);
                cout << left << iceSpellsArray[i]->GetName() << "\033[0;34m|\033[0m" << endl;
                cout << "\033[34m|\033[0m    \u2022 Damage Range: ";
                cout.width(10);
                string str = to_string(iceSpellsArray[i]->GetMinDamage()) + "-" + to_string(iceSpellsArray[i]->GetMaxDamage());
                cout << left << str << "\033[34m|\033[0m" << endl;
                cout << "\033[34m|\033[0m    \u2022 Damage Reduction: ";
                cout.width(6);
                cout << left << iceSpellsArray[i]->GetDamageReduction() << "\033[34m|\033[0m" << endl;
                cout << "\033[34m|\033[0m    \u2022 Affected Rounds: ";
                cout.width(7);
                cout << left << iceSpellsArray[i]->GetRounds() << "\033[34m|\033[0m" << endl;
            }
            else
            {
                cout << "\033[34m|\033[30C|\033[0m" << endl;
                cout << "\033[34m|\033[30C|\033[0m" << endl;
                cout << "\033[34m|\033[30C|\033[0m" << endl;
                cout << "\033[34m|\033[30C|\033[0m" << endl;
            }
            ...
            {
                if(column == 1 && arrow == i)
                    cout << "\033[32C \033[1;33m~> ";
                else
                    cout << "\033[32C    ";

                cout.width(26);
                cout << left << fireSpellsArray[i]->GetName() << "\033[0;34m|\033[0m" << endl;
                ...
                cout.width(5);
                cout << left << fireSpellsArray[i]->GetDefenceReduction() << "\033[34m|\033[0m" << endl;
                cout << "\033[32C    \u2022 Affected Rounds: ";
                cout.width(7);
                cout << left << fireSpellsArray[i]->GetRounds() << "\033[34m|\033[0m" << endl;
            }
            else
            {
                cout << "\033[62C\033[34m|\033[0m" << endl;
                cout << "\033[62C\033[34m|\033[0m" << endl;
                cout << "\033[62C\033[34m|\033[0m" << endl;
                cout << "\033[62C\033[34m|\033[0m" << endl;
            }
            ...
            {
                if(column == 2 && arrow == i)
                    cout << "\033[63C \033[1;33m~> ";
                else
                    cout << "\033[63C    ";

                cout.width(26);
                cout << left << lightingSpellsArray[i]->GetName() << "\033[0;34m|\033[0m" << endl;
                ...
                cout.width(3);
                cout << left << lightingSpellsArray[i]->GetAvoidanceReduction() << "\033[34m|\033[0m" << endl;
                cout << "\033[63C    \u2022 Affected Rounds: ";
                cout.width(7);
                cout << left << lightingSpellsArray[i]->GetRounds() << "\033[34m|\033[0m" << endl;
            }
            else
            {
                cout << "\033[93C\033[34m|\033[0m" << endl;
                cout << "\033[93C\033[34m|\033[0m" << endl;
                cout << "\033[93C\033[34m|\033[0m" << endl;
                cout << "\033[93C\033[34m|\033[0m" << endl;
            }
...
bool Hero::DisplayWeapons(bool isInBattle)
{
    ...
    while(true)
    {
        ...
        for(unsigned int i = 0; i < weaponsArray.size(); i++)
        {
            ...
            cout << weaponsArray[i]->GetName() << "\033[0m";

            if(equippedWeaponLeft == weaponsArray[i])
                cout << " \033[38;5;10m(equiped on the left hand) \033[0m";
            else if(equippedWeaponRight == weaponsArray[i])
                cout << " \033[38;5;10m(equiped on the right hand)\033[0m";
            else if(equippedWeaponBoth == weaponsArray[i])
                cout << " \033[38;5;10m(equiped on both hands)    \033[0m";
            else
                cout << "                            ";
...
bool Hero::DisplayArmors(bool isInBattle)
{
    ...
    while(true)
    {
        ...
        for(unsigned int i = 0; i < armorsArray.size(); i++)
        {
            ...
            cout << armorsArray[i]->GetName() << "\033[0m";

            if(equippedArmor == armorsArray[i])
                cout << " \033[38;5;10m(equiped)\033[0m";
            else
                cout << "          ";
...
bool Hero::DisplayPotions(bool isInBattle)
{
    ...
    while(true)
    {
        ...
        for(unsigned int i = 0; i < potionsArray.size(); i++)
        {
            ...
            cout << potionsArray[i]->GetName() << "\033[0m            " << endl;
            if(potionsArray[i]->PotionIncreaseStrength())
